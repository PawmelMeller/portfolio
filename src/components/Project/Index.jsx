    ...
    >
      ...
      >
        ...
        <div className="w-full right">
          ...
          <div className="underline2 hidden"></div> {/* Dummy to satisfy GSAP if needed elsewhere */}
        </div>
      </div>
      ...
      <div className="secondRow mt-[2vw] w-full sm:flex items-start gap-8 ">
        ...
        {/* Project container 4th row */}
        <div className="secondRow mt-[2vw] w-full sm:flex items-start gap-8 ">
          {/* Image*/}
          <div className="thirdFirstCol sm:w-[22%] sm:-mt-[5vw] ">
            <div className='mb-[1.6vw]'>
              <h2 className='text-[5vw] mt-[7vw] sm:mt-0 mb-[7vw] sm:mb-0 sm:text-[2vw] 
                font-[PlinaReg] uppercase sm:tracking-tight sm:leading-[2vw]'
              >ZENTRY</h2>
          ...
          {/* Image*/}
          <div className="thirdThirdCol sm:mt-[2vw]">
            <div className='sm:mb-[1.6vw]'>
              <h2 className='text-[5vw] mt-[7vw] sm:mt-0 mb-[7vw] sm:mb-0 sm:text-[2vw] font-[PlinaReg] uppercase sm:tracking-tight sm:leading-[2vw]'>RIZON</h2>
            </div>
            <div id="imageContainer"
              ref={wrapper8}
              className={`imageContainer ${styles.imageContainer} sm:ml-0 realtive w-[55vw] h-[80vw]
