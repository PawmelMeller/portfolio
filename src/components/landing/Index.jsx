  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1 className="sr-only">Zamów Stronę Która Działa i Sprzedaje</h1>
          <div
          ...
          >
            ...
            <div className={`hero ${styles.hero} relative z-[999] `} id="hero3">
              <div className="" aria-hidden="true">Która</div>
              <div aria-hidden="true">/</div>
              <div aria-hidden="true">Działa</div>
            </div>
            <div className={`hero ${styles.hero}`} id="hero4">
              <div aria-hidden="true">i Sprzedaje</div>
            </div>
          </div>
          <img
            id="flag"
            src={`${import.meta.env.BASE_URL}images/flag.jpg`}
            alt=""
