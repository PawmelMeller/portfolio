        ...
        <div className="w-full">
            ...
            >
                ...
                <div className="w-full right font-[PlinaReg]">
                    <div>
                        <Link to="/kontakt">
                            <div className="aboutHeading flex items-center overflow-hidden pb-[3vw] sm:pb-0 cursor-pointer">
                                <h2 className={`footText ${styles.footText} text-[9vw] leading-[10vw] tracking-tighter 
                    ...
                    <div className=" sm:flex items-start justify-between">
                        <div className="middle">
                            <h3 className="mb-[4vw] sm:mb-[1.5vw] sm:text-[.9vw]">Dane firmy</h3>
                            <h2 className="text-[5.4vw] leading-[6vw] sm:text-[1.4vw] sm:leading-[1.4vw]">Craze Studio</h2>
                            <h2 className="text-[5.4vw] leading-[6vw] sm:text-[1.4vw] sm:leading-[1.4vw]">ul. Kaszubska 7</h2>
                            <h2 className="text-[5.4vw] leading-[6vw] sm:text-[1.4vw] sm:leading-[1.4vw]">81-813 Sopot</h2>
                            <h2 className="text-[5.4vw] leading-[6vw] sm:text-[1.4vw] sm:leading-[1.4vw] mt-2">NIP: 583309792</h2>
                        </div>
                        <div className=" last sm:w-1/4">
                            <h3 className="mt-[8vw] mb-[4vw] sm:mt-0 sm:mb-[1.5vw] sm:text-[.9vw]">Kontakt</h3>
                            <h2 className="text-[5.8vw] leading-[6vw] sm:text-[1.4vw] sm:leading-[1.4vw] underline mb-4 hover:no-underline"><a href="mailto:kontakt@craze-studio.pl">kontakt@craze-studio.pl</a></h2>
                            <h2 className="text-[5.8vw] leading-[6vw] sm:text-[1.4vw] sm:leading-[1.4vw]"><a href="tel:508843219">508 843 219</a></h2>
                        </div>
                    </div>
                    <UnderLine marginBottom='2vw' marginTop='8vw' />
                    <h5 className="sm:text-[.9vw] pt-[3vw] sm:pt-0  ">Craze Studio &copy; 2024</h5>
                </div>
            </div>
        </div>
    )
