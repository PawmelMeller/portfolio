                ...
                <div className="w-full right font-[PlinaReg]">
                    ...
                    <div className=" sm:flex items-start justify-between">
                        <div className="middle">
                            ...
                            <h2 className="text-[5.4vw] leading-[6vw] sm:text-[1.4vw] sm:leading-[1.4vw]">Paweł Meller</h2>
                        ...
                        <div className=" last sm:w-1/4">
                            ...
                            <h2 className="text-[5.8vw] leading-[6vw] sm:text-[1.4vw] sm:leading-[1.4vw] underline mb-4 hover:no-underline"><a href="mailto:pawel.meller3@gmail.com">pawel.meller3@gmail.com</a></h2>
                    ...
                    <h5 className="sm:text-[.9vw] pt-[3vw] sm:pt-0  ">Paweł Meller &copy; 2024</h5>
                </div>
            </div>
        </div>
    )
